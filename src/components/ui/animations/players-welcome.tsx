...
export default function PlayersWelcome({
  ...
  useEffect(() => {
    const timer = setTimeout(() => setStop(true), 2.7 * 1000)
  ...
  return (
    ...
    <AnimatePresence>
      {!stop && (
        <motion.div exit={{ opacity: 0 }} transition={{ delay: 0.8 }} className="absolute inset-0 bg-stone-900 flex items-center justify-center overflow-hidden z-[99]">
          <motion.div
